...
TARGET_102=${WORK_DIR}/workspace/DPU-PYNQ/host/arch_ultra96.json
...
##################################################################################
# Compile xmodel file for ultra96v2 board with Vitis AI Compiler
6_compile() {
  echo " "
  echo "##########################################################################"
  ...
  vai_c_tensorflow \
    ...
    --arch /workspace/DPU-PYNQ/host/arch_ultra96.json
